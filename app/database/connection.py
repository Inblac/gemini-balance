...
if settings.DATABASE_TYPE == "sqlite":
    ...
    DATABASE_URL = f"postgresql+psycopg2://{settings.MYSQL_USER}:{quote_plus(settings.MYSQL_PASSWORD)}@{settings.MYSQL_HOST}:{settings.MYSQL_PORT}/{settings.MYSQL_DATABASE}"
